...
var categories = map[string][]string{
	...
	"20%":  {"CountDown", "StrLen", "PrintIf", "PrintIfNot", "RectPerimeter", "CountCharacter"},
	"30%":  {"Gcd", "FirstRune", "LastRune", "LastWord", "ReduceInt", "HashCode", "DigitLen", "CamelToSnakeCase", "RepeatAlpha"},
	"40%":  {"AlphaMirror", "Chunk", "Doop", "FindPrevPrime", "FoldInt", "SearchReplace", "TabMult", "RetainFirstHalf", "IsCapitalized", "PrintMemory", "FifthAndSkip", "FromTo", "PrintRevComb"},
	"50%":  {"Inter", "IsPowerof2", "PigLatin", "PrintBits", "ReverseBits", "RomanNumbers", "SwapBits", "Union", "WdMatch", "ConcatSlice", "ReverseStrCap"},
	"60%":  {"PrintHex", "SortWordArr", "ZipString", "NotDecimal", "RevConcatAlternate", "ExpandStr"},
